...
class TestTestQuestionInfoModel:
    ...
    def test_foreign_key_protect_on_delete(self):
        ...
        TestQuestionInfo.objects.create(
            name="Test Question",
            subject=temp_subject,
            score=10,
            tq_type="xz",
        ...
        # PROTECT이므로 삭제 시 ProtectedError 발생해야 함
...
class TestTestPaperInfoModel:
    ...
    def test_total_score_default_value(self):
        ...
        paper = TestPaperInfo.objects.create(
            name="Test Paper", subject=self.subject, tp_degree="jd", create_user=self.user
        )
    ...
    def test_name_max_length(self):
        ...
        paper = TestPaperInfo(
            name=long_name, subject=self.subject, tp_degree="jd", create_user=self.user
        )
...
class TestTestPaperTestQModel:
    ...
    def test_unique_together_constraint(self):
        ...
        TestPaperTestQ.objects.create(
            test_paper=self.paper, test_question=self.question1, score=10, order=1
        )
        ...
        with pytest.raises(IntegrityError):
            with transaction.atomic():
                TestPaperTestQ.objects.create(
                    test_paper=self.paper, test_question=self.question1, score=10, order=2
                )
    ...
    def test_ordering_by_order_field(self):
        ...
        # 역순으로 생성
        TestPaperTestQ.objects.create(
            test_paper=self.paper, test_question=self.question2, score=10, order=2
        )
        TestPaperTestQ.objects.create(
            test_paper=self.paper, test_question=self.question1, score=10, order=1
        )
    ...
    def test_score_default_value(self):
        ...
        mapping = TestPaperTestQ.objects.create(
            test_paper=self.paper, test_question=self.question1, order=1
        )
    ...
    def test_order_default_value(self):
        ...
        mapping = TestPaperTestQ.objects.create(
            test_paper=self.paper, test_question=self.question1, score=10
        )
    ...
    def test_cascade_delete_on_paper(self):
        ...
        temp_paper = TestPaperInfo.objects.create(
            name="Temp Paper", subject=self.subject, tp_degree="jd", create_user=self.user
        )

        mapping = TestPaperTestQ.objects.create(
            test_paper=temp_paper, test_question=self.question1, score=10, order=1
        )
...
class TestTestScoresModel:
    ...
    def test_test_score_default_zero(self):
        ...
        score = TestScores.objects.create(user=self.student, test_paper=self.paper)
    ...
    def test_detail_records_json_storage(self):
        ...
        score = TestScores.objects.create(
            user=self.student, test_paper=self.paper, detail_records=answer_data
        )
    ...
    def test_test_paper_set_null_on_delete(self):
        ...
        score = TestScores.objects.create(user=self.student, test_paper=temp_paper, test_score=80)
        score_id = score.id
...
class TestOptionInfoModel:
    ...
    def test_option_max_length(self):
        ...
        option = OptionInfo(test_question=self.question, option=long_option, is_right=True)
    ...
    def test_is_right_default_true(self):
        ...
        option = OptionInfo.objects.create(test_question=self.question, option="Test Option")
    ...
    def test_cascade_delete_on_question(self):
        ...
        option = OptionInfo.objects.create(
            test_question=temp_question, option="Option A", is_right=True
        )
        option_id = option.id
    ...
    def test_multiple_options_per_question(self):
        ...
        for option_text, is_right in options_data:
            OptionInfo.objects.create(
                test_question=self.question, option=option_text, is_right=is_right
            )
        ...
        # 정답은 1개인지 확인
        assert OptionInfo.objects.filter(test_question=self.question, is_right=True).count() == 1
