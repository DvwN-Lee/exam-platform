...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        from user.models import StudentsInfo, SubjectInfo, TeacherInfo
        ...
        teacher_user, created = user_model.objects.get_or_create(
        ...
        for name in subjects_data:
            subject, created = SubjectInfo.objects.get_or_create(subject_name=name)
            ...
            if created:
                for opt_content, is_right in q_data["options"]:
                    OptionInfo.objects.create(
                        test_question=question, option=opt_content, is_right=is_right
                    )
