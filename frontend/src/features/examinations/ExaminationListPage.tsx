...
import type { ExaminationFilters, ExaminationStatus } from '@/types/testpaper'
...
export function ExaminationListPage() {
  ...
  const handleFilterChange = (key: keyof ExaminationFilters, value: any) => {
  ...
  const getExamStatus = (examination: any): ExaminationStatus => {
    const now = new Date()
      ...
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="space-y-4">
          {data?.results.length === 0 ? (
            ...
            data?.results.map((examination) => {
              const status = getExamStatus(examination)
              return (
                <div
                  key={examination.id}
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <div className="mt-2 flex items-center gap-4 text-sm text-muted-foreground">
                        ...
                        <span>
                          종료: {new Date(examination.end_time).toLocaleString('ko-KR')}
                        </span>
