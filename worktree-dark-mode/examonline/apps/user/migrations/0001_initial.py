    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mobile",
                    models.CharField(
                        blank=True, default="", max_length=11, null=True, verbose_name="전화 번호"
                    ),
                ),
                (
                    "user_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "send_time",
                    models.DateTimeField(default=datetime.datetime.now, verbose_name="발송 시간"),
                ),
            ],
            options={
                "verbose_name": "이메일코드",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "student_name",
                    models.CharField(default="", max_length=20, verbose_name="학생 이름"),
                ),
                ("student_id", models.CharField(default="", max_length=20, verbose_name="학번")),
                (
                    "student_class",
                    models.CharField(default="", max_length=10, verbose_name="학생 학급"),
                ),
                (
                    "student_school",
                    models.CharField(default="", max_length=100, verbose_name="학생 소속 학교"),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "subject_name",
                    models.CharField(default="", max_length=20, verbose_name="과목 명칭"),
                ),
                (
                    "create_time",
                    models.DateTimeField(default=datetime.datetime.now, verbose_name="생성 시간"),
                ),
            ],
            options={
                "verbose_name": "과목 정보",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "teacher_name",
                    models.CharField(default="", max_length=20, verbose_name="선생 이름"),
                ),
                ("work_years", models.IntegerField(default=0, verbose_name="근무년도")),
                (
                    "teacher_school",
                    models.CharField(default="", max_length=100, verbose_name="선생 소속 학교"),
                ),
                (
                    "subject",
                    models.ForeignKey(
