...
class TestQuestionInfo(models.Model):
    ...
    subject = models.ForeignKey(
        SubjectInfo, on_delete=models.PROTECT, verbose_name="소속 과목", default=""
    )
    ...
    create_user = models.ForeignKey(
        UserProfile, on_delete=models.SET_NULL, null=True, verbose_name="출제자"
    )
    ...
    class Meta:
        ...
        indexes = [
            models.Index(fields=["subject", "tq_type", "tq_degree"]),
            models.Index(fields=["is_del", "is_share"]),
        ]
...
class OptionInfo(models.Model):
    test_question = models.ForeignKey(
        TestQuestionInfo, on_delete=models.CASCADE, verbose_name="시험 문제 정보"
    )
