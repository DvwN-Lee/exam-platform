...
resource "google_secret_manager_secret" "db_host" {
  secret_id = "examonline-prod-db-host"
...
resource "google_secret_manager_secret" "db_port" {
  secret_id = "examonline-prod-db-port"
...
resource "google_secret_manager_secret" "db_name" {
  secret_id = "examonline-prod-db-name"
...
resource "google_secret_manager_secret" "db_user" {
  secret_id = "examonline-prod-db-user"
...
resource "google_secret_manager_secret" "db_password" {
  secret_id = "examonline-prod-db-password"
...
resource "google_secret_manager_secret" "redis_host" {
  secret_id = "examonline-prod-redis-host"
...
resource "google_secret_manager_secret" "redis_port" {
  secret_id = "examonline-prod-redis-port"
...
resource "google_secret_manager_secret" "redis_password" {
  secret_id = "examonline-prod-redis-password"
...
resource "google_secret_manager_secret" "django_secret_key" {
  secret_id = "examonline-prod-django-secret-key"
...
resource "google_secret_manager_secret" "jwt_secret_key" {
  secret_id = "examonline-prod-jwt-secret-key"
...
resource "google_secret_manager_secret" "gcs_bucket_name" {
  secret_id = "examonline-prod-gcs-bucket-name"
